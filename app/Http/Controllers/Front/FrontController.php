...
// }
  ...
  'itemListElement' => $breed,
            ...
            return view('front.product_detail1',compact('allcatagories','sett','product','rcount','category_id','rproducts','cate','meta','faq','rating','Slider','product_detail','meta_file'));
