              ...
              <form role="form" class="form-inline" autocomplete="off" method="post">
                  @csrf
                        <div class="form-group" style="display: flex;flex-direction: column;">
                          <label for="exampleInputEmail2">Clarity</label>
          ...
          <tbody>
            ...
            @foreach ($categories as $item)
                <tr>
                  ...
                  <td>
                    <a href="{{route('admins.clarity')}}/{{$item->id}}" class="btn btn-warning">Edit</a>
                    <a href="javascript:void(0)" data-href="{{route('admins.clarity')}}/{{$item->id}}/{{'delete'}}"  class="btn btn-danger delete_record">Delete</a>
                  </td>
                </tr>
            @endforeach
          </tbody>
