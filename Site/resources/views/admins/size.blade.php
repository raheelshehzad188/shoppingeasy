...
@section('product_attribute_1_active','active')
          ...
          <tbody>
            ...
            @foreach ($categories as $item)
                <tr>
                  ...
                  <td>
                    <a href="{{route('admins.size')}}/{{$item->id}}" class="btn btn-warning">Edit</a>
                    <a href="javascript:void(0)" data-href="{{route('admins.size')}}/{{$item->id}}/{{'delete'}}"  class="btn btn-danger delete_record">Delete</a>
                  </td>
                </tr>
            @endforeach
          </tbody>
