...
if(isset($_POST['change']))
{
  ...
  $password = mysqli_real_escape_string($con,$_POST['oldpass']);
  $hash=$fetch['password'];
  if(password_verify($password,$hash)){
      $newpass=mysqli_real_escape_string($con,password_hash($_POST['newpass'],PASSWORD_DEFAULT));
			...
			if($rowcount>0){
					$_SESSION['msg1']='Success.Your password has been change.';
			}
			else{
		        	$_SESSION['msg1']= 'Unsuccess.Your password has not been change.';
			}
            }else{
					$_SESSION['msg1']='  Unsuccess.Your old password is wrong.';
			}
}
?>
